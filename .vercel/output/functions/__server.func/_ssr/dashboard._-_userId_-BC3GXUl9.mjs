...
import { C as CurrentMatchCard, a as CurrentMatchLoader, b as MatchCarousel, M as MatchCarouselLoader, c as Carousel, d as CarouselContent, e as CarouselItem, f as CarouselPrevious, g as CarouselNext } from "./match-carousel-loader-BwrVhPsL.mjs";
import { C as Card, a as CardHeader, d as CardTitle, f as CardAction, b as CardContent, c as CardFooter } from "./card-C1_QmPp_.mjs";
import { n as Route, o as userFormQueryOptions, C as CloudImage, c as cn, S as Skeleton, w as winnerPredByNumQueryOptions, j as currDBUserQueryOptions, a as allUsersQueryOptions, B as Button, r as resultsQueryOptions, q as userPredsQueryOptions } from "./router-DxMd2jbb.mjs";
import { A as Amount, P as PredCarouselItem, u as useAppForm, S as SelectItem } from "./hooks-Cm2QxnsM.mjs";
...
import { M as Modal } from "./modal-C19Gzmjm.mjs";
import { T as Table, a as TableCaption, b as TableHeader, c as TableRow, d as TableHead, e as TableBody, f as TableCell, g as TableFooter } from "./table-D4-zTf23.mjs";
import { a as useUpsertProfile } from "./hooks-BPSW1som.mjs";
import { P as ProfileSchema, e as TEAMS } from "./schemas-pJJa3z0V.mjs";
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-8 gap-4 md:gap-8 items-start justify-start w-full p-4 md:p-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-2 lg:order-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PredCarouselLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PredCarousel, { match: {}, preds: predictions ?? [], title: `${userId ? `${predictions?.[0]?.user?.firstName ?? ""}` : "Your"} Predictions` }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-3 lg:order-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentMatchLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentMatchCard, {}) }) }),
