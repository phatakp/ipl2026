...
import { a as auth, b as api, h as handleAPIError } from "./axios-B_vivTEI.mjs";
...
}, (opts) => getIsAuthenticated.__executeServer(opts));
...
const getAllUsersFromDB_createServerFn_handler = createServerRpc({
  ...
  filename: "src/data/users/services.ts"
}, (opts) => getAllUsersFromDB.__executeServer(opts));
...
const getUserByIdFromDB_createServerFn_handler = createServerRpc({
  ...
  filename: "src/data/users/services.ts"
}, (opts) => getUserByIdFromDB.__executeServer(opts));
...
const getUserFormById_createServerFn_handler = createServerRpc({
  ...
  filename: "src/data/users/services.ts"
}, (opts) => getUserFormById.__executeServer(opts));
...
const activateProfile_createServerFn_handler = createServerRpc({
  ...
  filename: "src/data/users/services.ts"
}, (opts) => activateProfile.__executeServer(opts));
