...
import { C as Card, a as CloudImage } from "./card-B9zI1dWD.mjs";
import { R as Root2, L as List, T as Trigger, C as Content } from "../_chunks/_libs/@radix-ui/react-tabs.mjs";
import { c as cn, b as allTeamsQueryOptions, t as teamFormQueryOptions, r as resultsQueryOptions } from "./router-D0bPNyc3.mjs";
...
const FormStat = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        form?.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
        ...
        form?.length <= 0 && [1, 2, 3].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            variant: "outline",
