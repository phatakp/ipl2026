...
import { g as Carousel, h as CarouselContent, i as CarouselItem, d as CloudImage, k as CarouselPrevious, l as CarouselNext, C as Card } from "./card-CUHFot7k.mjs";
import { B as Button, c as cn, v as fixturesQueryOptions } from "./router-Bkbp-GnV.mjs";
import { B as Badge } from "./badge-C6g5EFmO.mjs";
import { c as Calendar, d as Pin, b as CircleArrowOutUpRight, e as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-[calc(100vw-32px)] lg:w-full flex-col gap-3 py-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Carousel,
      {
        ...
        className: "w-full",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { className: "-ml-2 flex-row", children: fixtures.slice(1).map((match, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          CarouselItem,
          {
