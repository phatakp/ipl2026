...
import { C as CurrentMatchCard, a as CurrentMatchLoader, b as MatchCarousel, M as MatchCarouselLoader, c as Carousel, d as CarouselContent, e as CarouselItem, f as CarouselPrevious, g as CarouselNext } from "./match-carousel-loader-Cvf93Y3A.mjs";
import { C as Card, a as CardHeader, d as CardTitle, f as CardAction, b as CardContent, c as CardFooter } from "./card-BjC3LJSY.mjs";
import { n as Route, o as userFormQueryOptions, C as CloudImage, c as cn, S as Skeleton, w as winnerPredByNumQueryOptions, j as currDBUserQueryOptions, a as allUsersQueryOptions, B as Button, r as resultsQueryOptions, q as userPredsQueryOptions } from "./router-Dj_6u3nh.mjs";
import { A as Amount, P as PredCarouselItem, u as useAppForm, S as SelectItem } from "./hooks-BqsWxlFT.mjs";
import { u as useAuth } from "../_chunks/_libs/@clerk/clerk-react.mjs";
import { f as useNavigate } from "../_chunks/_libs/@tanstack/react-router.mjs";
import { B as Badge } from "./badge-DGgqKuOI.mjs";
import { M as Modal } from "./modal-B8TOed4i.mjs";
import { T as Table, a as TableCaption, b as TableHeader, c as TableRow, d as TableHead, e as TableBody, f as TableCell, g as TableFooter } from "./table-CKYT5XNi.mjs";
import { a as useUpsertProfile } from "./hooks-D5ustaTX.mjs";
import { P as ProfileSchema, e as TEAMS } from "./schemas-BR2X-gUy.mjs";
import { b as CircleArrowOutUpRight, c as Calendar, P as Pin, d as Pen, e as ArrowUpRight } from "../_libs/lucide-react.mjs";
...
function PredCarouselLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-8 w-full py-4 rounded-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "title text-2xl", children: "Predictions" }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CarouselContent,
                {
                  ...
                  children: preds.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { className: "basis-1/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PredCarouselItem,
                    {
                      pred: p,
                      isUserPred,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselPrevious, { hidden: preds.length < 5 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselNext, { hidden: preds.length < 5 })
            ]
          }
        )
      ]
...
function PlayerStandingsLoader() {
...
function FullStandingsTable() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCaption, { children: "Player Standing 2026" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "", children: "#" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Doubles" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "Points" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: players?.map((player) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: player.rank }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "capitalize truncate", children: [
          player.firstName,
          " ",
          player.lastName
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base text-muted-foreground", children: player.team })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: player.doublesLeft }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 3, children: "Total Players" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right flex items-center justify-end gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold", children: players.length }),
        currUser?.role === "ADMIN" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: total.toFixed(0) })
      ] })
    ] }) })
  ] });
}
function FullStandingsBtn() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      content: /* @__PURE__ */ jsxRuntimeExports.jsx(FullStandingsTable, {}),
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", children: [
        "View full table ",
...
function PlayerStandings() {
  ...
  if (!isLoaded) return /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerStandingsLoader, {});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-[calc(100vw-32px)] lg:w-full flex-col gap-3 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Carousel, { setApi: setMainApi, className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { children: users.map((user, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow relative w-[calc(100vw-32px)] lg:w-full h-full md:min-h-[37vh] rounded-lg overflow-hidden p-0 flex flex-col gap-4 ", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col pb-20 sm:pb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "title text-3xl font-team capitalize", children: [
          user?.firstName,
          " ",
          user?.lastName
        ] }),
        user?.clerkId && user.clerkId === loggedInUserId && !user.isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "", variant: "destructive", children: "Your profile is not active yet!" }),
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm md:pt-2 md:text-base capitalize", children: u?.firstName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm md:pb-8 capitalize", children: u?.lastName }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FullStandingsBtn, {})
    ] })
  ] });
}
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-8 gap-4 md:gap-8 items-start justify-start w-full p-4 md:p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerStandingsLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerStandings, {}) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PredCarouselLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PredCarousel, { match: {}, preds: predictions ?? [], title: `${userId ? `${predictions?.[0]?.user?.firstName ?? ""}` : "Your"} Predictions` }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentMatchLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentMatchCard, {}) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-4 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCarouselLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCarousel, { matches: results ?? [], title: "Match Results" }) }) })
  ] });
}
export {
