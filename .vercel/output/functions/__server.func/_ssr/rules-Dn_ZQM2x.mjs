    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "single", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "item-1", className: "border-none py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-pretty py-4 font-normal title", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "list-inside list-disc space-y-4 text-base", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            ...
            ". This doubles the winning/lost amount for the match.",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2 underline underline-offset-2 font-semibold text-foreground", children: "9130469142 (PhonePe / GPay)" }),
            "compulsorily before start of Match 1.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            " Until then the player status will be inactive and they will not be able to place predictions."
          ] }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "item-2", className: "border-none py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-pretty py-4 font-normal title", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "list-inside list-disc space-y-4 text-base", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { className: "my-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: "Rs.50/-" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: "Qualifiers/Eliminator" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: "Rs.100/-" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: "Final" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: "Rs.200/-" })
                ] })
              ] })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Minimum Double amount will be 2x of current highest stake for the match. If current highest bet is 60, minimum double will be 120." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-foreground", children: [
            "Doubles can be overridden by another double (but will need 2x of current double amount as stake.) ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "item-3", className: "border-none py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-pretty py-4 font-normal title", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "list-inside list-disc space-y-4 text-base", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { className: "mt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: "Increase of stake amount" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: "Allowed until start of match" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: "Reduction of stake amount" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "Stake amount should be 2x the current stake." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { className: "my-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: "Stake amount to be debited from balance." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: "Credit Amount = (Your Stake / Total Winning stake amount) x Total Losing stake amount" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { children: [
                    "2 x Min Stake amount for match to be debited from balance",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground", children: [
                      " ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { children: [
                    ...
                    " ",
                    "+ ((Your Stake / Total Winning stake amount) x Total Losing stake amount)"
                  ] })
                ] })
              ] })
            ] })
