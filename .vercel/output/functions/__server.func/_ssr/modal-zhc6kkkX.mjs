...
import { c as cn } from "./router-CNR_rhTz.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-full max-h-[calc(100vh-120px)] my-auto me-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: content }) })
        ]
      }
    )
  ] }) });
