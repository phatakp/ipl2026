...
import { C as CloudImage, B as Button, c as cn, S as Skeleton, t as fixturesQueryOptions } from "./router-BUPg0k2i.mjs";
import { C as Card } from "./card-BEgXlTRU.mjs";
      ...
      Link,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 z-10 w-full sm:items-center pt-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-fit", children: match.hasDoubleCutoffPassed ? "Match Details" : "Predict Now" })
          ] })
        ]
      }
    ) }) }, index)) }) }),
