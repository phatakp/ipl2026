...
import { g as Carousel, h as CarouselContent, i as CarouselItem, k as CarouselPrevious, l as CarouselNext, C as Card, a as CloudImage } from "./card-BfQTkcUj.mjs";
import { w as winnerPredByNumQueryOptions, c as cn, v as amountFormatter, B as Button, y as formatDate, S as Skeleton, x as buttonVariants } from "./router-Mlx62I7m.mjs";
...
import { e as ChevronRight, f as Check, M as Minus, g as Plus, c as Calendar$1, X, h as ChevronLeft, C as ChevronDown, i as LoaderCircle, j as ChevronUp } from "../_libs/lucide-react.mjs";
...
function Amount({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("flex items-center justify-end", containerClass), children: integerPart && decimalPart ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end", children: [
    ...
    Link,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-[calc(100%-2rem)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pl-4 w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CloudImage,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("w-full py-2 px-4 flex flex-col "), children: [
                  isUserPred ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 wrap-break-word md:w-100 truncate", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(" font-sans text-lg md:text-xl"), children: pred.user.firstName }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(" font-sans text-lg"), children: pred.user.lastName })
                    ] }),
                    !["PLACED", "DEFAULT"].includes(pred.status) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm ", children: [
                      "Points at Stake:",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Amount, { amount: pred.amount, className: "text-sm" })
                    ] })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 font-normal", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                pred.isDouble && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-base", children: "Double" }),
