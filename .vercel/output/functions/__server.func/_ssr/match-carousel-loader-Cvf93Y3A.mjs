...
import { C as CloudImage, B as Button, c as cn, S as Skeleton, t as fixturesQueryOptions } from "./router-Dj_6u3nh.mjs";
import { C as Card } from "./card-BjC3LJSY.mjs";
import { u as useEmblaCarousel } from "../_libs/embla-carousel-react.mjs";
import { B as Badge } from "./badge-DGgqKuOI.mjs";
import { c as Calendar, P as Pin, b as CircleArrowOutUpRight, f as ChevronRight, g as ArrowLeft, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
function CurrentMatchCard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-[calc(100vw-32px)] lg:w-full flex-col gap-3 py-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Carousel, { setApi: setMainApi, className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { children: fixtures.map((match, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shadow relative w-[calc(100vw-32px)] lg:w-full h-full md:min-h-[30vh] rounded-lg overflow-hidden p-4 pt-0 flex flex-col gap-4 bg-[url('/bg.jpg')] bg-no-repeat bg-cover", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 z-10 w-full sm:items-center pt-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-fit", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/matches/$matchNum",
            params: { matchNum: match.number },
            children: match.hasDoubleCutoffPassed ? "Match Details" : "Predict Now"
          }
        ) }) })
      ] })
    ] }) }) }, index)) }) }),
...
export {
  ...
  MatchCarousel as b,
  Carousel as c,
  CarouselContent as d,
  CarouselItem as e,
  CarouselPrevious as f,
  CarouselNext as g
};
