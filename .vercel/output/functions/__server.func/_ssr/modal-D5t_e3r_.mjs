...
import { R as Root$1, T as Trigger, C as Content, a as Close, b as Title, D as Description, P as Portal, O as Overlay } from "../_chunks/_libs/@radix-ui/react-dialog.mjs";
import { c as cn } from "./router-DP86RmCx.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-full max-h-[calc(100vh-10rem)] my-auto me-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: content }) })
        ]
      }
    )
  ] }) });
