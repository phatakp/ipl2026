...
import { C as CurrentMatchCard, M as MatchCarousel } from "./match-carousel-CfnEF4Yb.mjs";
import { I as Image } from "../_chunks/_libs/@unpic/react.mjs";
import { C as Card } from "./card-CUHFot7k.mjs";
import { R as Root2, L as List, T as Trigger, C as Content } from "../_chunks/_libs/@radix-ui/react-tabs.mjs";
import { c as cn, b as allTeamsQueryOptions, t as teamFormQueryOptions, r as resultsQueryOptions } from "./router-Bkbp-GnV.mjs";
...
const FormStat = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: form?.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-8 gap-4 items-start justify-start w-full py-8 px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2 order-2 lg:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading Points Table..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PointsTable, {}) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 order-1 lg:order-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading Current Match..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrentMatchCard, {}) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2 order-3 lg:px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading Results..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCarousel, { matches: results ?? [], title: "Results" }) }) })
  ] });
}
export {
  App as component
