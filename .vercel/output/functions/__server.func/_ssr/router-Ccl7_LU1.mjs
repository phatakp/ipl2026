...
import { A as ADMINROLE, M as MatchSchema, P as ProfileSchema, T as TEAMNAMES, a as PredictionSchemaWithValidation, b as PredictionSchema } from "./schemas-pJJa3z0V.mjs";
...
import { g as getIsAuthenticated, c as createSsrRpc, a as getAllUsersFromDB, b as getUserByIdFromDB, d as getCurrUserFromDB, e as getUserFormById } from "./services-DjdOH3KL.mjs";
...
function Logo({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center ipl-logo relative w-25 text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    CloudImage,
    {
      name: "logo_ipl",
      width: 100,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center justify-between mx-auto max-w-360 w-full h-full py-4 md:py-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-8 text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              href: "/",
              title: "Home",
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "md:hidden text-foreground" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SignedIn, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              NavLink,
              {
                href: "/dashboard",
                title: "Dashboard",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { className: "md:hidden  text-foreground" })
              }
            ),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(
              NavLink,
              {
                href: "/admin",
                title: "Admin",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserKey, { className: "md:hidden text-foreground" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              href: "/rules",
              title: "Rules",
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Handshake, { className: "md:hidden text-foreground" })
            }
          )
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SignedOut, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", asChild: true, className: "bg-chart-1 text-card-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/sign-in/$", className: "flex items-center ", children: [
          "Login ",
...
function NavLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: href, className: "flex flex-col items-center gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:flex text-foreground font-semibold", children: title }),
    icon,
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
...
const appCss = "/assets/styles-C-kXMeaI.css";
...
const $$splitComponentImporter$6 = () => import("./rules-I1EvOZjh.mjs");
...
const $$splitComponentImporter$5 = () => import("./admin-D1iX05o9.mjs");
...
const $$splitComponentImporter$4 = () => import("./index-Bd40L-6L.mjs");
...
const $$splitComponentImporter$3 = () => import("./sign-up._-CTr1feet.mjs");
const Route$3 = createFileRoute("/sign-up/$")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./sign-in._-DNMxoGoO.mjs");
...
const $$splitComponentImporter$1 = () => import("./matches._matchNum-Cge-CdMI.mjs");
const Route$1 = createFileRoute("/matches/$matchNum")({
  ...
  loader: async ({
    ...
    context.queryClient.ensureQueryData(matchByNumQueryOptions(params.matchNum));
    context.queryClient.ensureQueryData(matchPredsQueryOptions(params.matchNum));
    context.queryClient.ensureQueryData(currUserMatchPredQueryOptions(params.matchNum));
  },
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./dashboard._-_userId_-DpVyKRz1.mjs");
const Route = createFileRoute("/dashboard/{-$userId}")({
  ...
  loader: async ({
    ...
    context.queryClient.ensureQueryData(fixturesQueryOptions());
    context.queryClient.ensureQueryData(resultsQueryOptions());
    context.queryClient.ensureQueryData(userPredsQueryOptions(params.userId ?? context.loggedInUserId));
    if (params.userId) context.queryClient.ensureQueryData(dBUserQueryOptions(params.userId));
...
export {
  ...
  userKeys as s,
  fixturesQueryOptions as t,
  updateMatch as u,
  amountFormatter as v,
  winnerPredByNumQueryOptions as w,
  buttonVariants as x,
  formatDate as y,
  router as z
};
