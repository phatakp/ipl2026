...
const MatchSchema = z4.object({
  number: z4.number({ error: "Match Num is required" }).min(1, { error: "Match Num must be at least 1" }).max(99, { error: "Match Num must be at most 99" }),
  ...
  resultMargin: z4.coerce.number().int().min(0),
...
const PredictionSchema = z4.object({
  id: z4.union([z4.string(), z4.undefined()]),
  matchNumber: z4.number({ error: "Match Num is required" }).min(1, { error: "Match Num must be at least 1" }).max(99, { error: "Match Num must be at most 99" }),
  team: z4.union([
