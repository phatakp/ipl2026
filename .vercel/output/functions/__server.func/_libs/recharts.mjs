...
var adaptEventsOfChild = function adaptEventsOfChild2(props, data, index) {
  if (!isObject(props) || _typeof$C(props) !== "object") {
    return null;
  }
  var out = null;
...
var _excluded$f = ["children"], _excluded2$5 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$f(_ref2, _excluded2$5);
    if (nextChildren && prevChildren) {
  ...
  return _createClass$f(Legend2, [{
    ...
    value: function getBBoxSnapshot() {
      if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) {
        return _objectSpread$t({}, this.lastBoundingBox);
      }
      return {
        width: 0,
        height: 0
    ...
    value: function getDefaultPosition(style) {
      ...
      return _objectSpread$t(_objectSpread$t({}, hPos), vPos);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, renderContent$1(content, _objectSpread$t(_objectSpread$t({}, this.props), {}, {
    ...
    value: function getWithHeight(item, chartWidth) {
      var _this$defaultProps$it = _objectSpread$t(_objectSpread$t({}, this.defaultProps), item.props), layout = _this$defaultProps$it.layout;
...
var TooltipBoundingBox = /* @__PURE__ */ (function(_PureComponent) {
  function TooltipBoundingBox2() {
    ...
    _defineProperty$v(_this, "handleKeyDown", function(event) {
      if (event.key === "Escape") {
  ...
  return _createClass$e(TooltipBoundingBox2, [{
    ...
    value: function render() {
      ...
      var outerStyle = _objectSpread$r(_objectSpread$r({
  ...
  return _createClass$d(Tooltip2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ React.createElement(TooltipBoundingBox, {
        ...
        viewBox,
        wrapperStyle
      }, renderContent(content, _objectSpread$q(_objectSpread$q({}, this.props), {}, {
  ...
  var chartContent = reactExports.useMemo(function() {
    ...
    return React.Children.map(children, function(child) {
      if (/* @__PURE__ */ React.isValidElement(child)) {
        return /* @__PURE__ */ reactExports.cloneElement(child, _objectSpread$p({
...
var _excluded$a = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], _excluded2$4 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$k() {
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$a(props, _excluded2$4);
...
_defineProperty$r(ErrorBar, "defaultProps", {
  stroke: "black",
  strokeWidth: 1.5,
  width: 5,
  offset: 0,
...
_defineProperty$r(ErrorBar, "displayName", "ErrorBar");
...
var getLegendProps = function getLegendProps2(_ref) {
  ...
  var legendProps = legendDefaultProps !== void 0 ? _objectSpread$n(_objectSpread$n({}, legendDefaultProps), legendItem.props) : {};
  var legendData;
  if (legendItem.props && legendItem.props.payload) {
    ...
    legendData = (formattedGraphicalItems || []).map(function(_ref3) {
      ...
      var itemProps = itemDefaultProps !== void 0 ? _objectSpread$n(_objectSpread$n({}, itemDefaultProps), item.props) : {};
  ...
  return _objectSpread$n(_objectSpread$n(_objectSpread$n({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
    payload: legendData,
    item: legendItem
  });
};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem2(item) {
  ...
  var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread$m(_objectSpread$m({}, item.type.defaultProps), item.props) : item.props;
  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread$m(_objectSpread$m({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
...
var appendOffsetOfLegend = function appendOffsetOfLegend2(offset, _unused, props, legendBox) {
  ...
  if (legendProps) {
    ...
    if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) {
      return _objectSpread$m(_objectSpread$m({}, offset), {}, _defineProperty$p({}, align, offset[align] + (boxWidth || 0)));
    }
    if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) {
      return _objectSpread$m(_objectSpread$m({}, offset), {}, _defineProperty$p({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
    }
  }
  return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId2(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
  ...
  var stackGroups = items.reduce(function(result, item) {
    var _item$type2;
    var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread$m(_objectSpread$m({}, item.type.defaultProps), item.props) : item.props;
    ...
    return _objectSpread$m(_objectSpread$m({}, result), {}, _defineProperty$p({}, axisId, parentGroup));
  ...
  return Object.keys(stackGroups).reduce(function(result, axisId) {
    ...
    if (group.hasStack) {
      ...
      group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
        ...
        return _objectSpread$m(_objectSpread$m({}, res), {}, _defineProperty$p({}, stackId, {
          numericAxisId,
          cateAxisId,
          items: g.items,
    ...
    return _objectSpread$m(_objectSpread$m({}, result), {}, _defineProperty$p({}, axisId, group));
...
var getStackedDataOfItem = function getStackedDataOfItem2(item, stackGroups) {
  var _item$type3;
  var defaultedProps = (_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread$m(_objectSpread$m({}, item.type.defaultProps), item.props) : item.props;
...
var getTooltipItem = function getTooltipItem2(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread$m(_objectSpread$m({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
  ...
  return _objectSpread$m(_objectSpread$m({}, filterProps(graphicalItem, false)), {}, {
    dataKey,
    unit,
    formatter,
    name: name || dataKey,
...
var _excluded$7 = ["valueAccessor"], _excluded2$3 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(Layer, {
    ...
    return /* @__PURE__ */ React.createElement(Label, _extends$h({}, filterProps(entry, true), others, idProps, {
      ...
      value,
      textBreakAll,
      viewBox: Label.parseViewBox(isNil(clockWise) ? entry : _objectSpread$j(_objectSpread$j({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
