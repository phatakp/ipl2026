...
import { J as Js, t as te, a as an, l as ln } from "../../../_libs/seroval.mjs";
import { u } from "../../../_libs/seroval-plugins.mjs";
...
var ShallowErrorPlugin = /* @__PURE__ */ Js({
  tag: "$TSR/Error",
  test(value) {
...
var INITIAL_SCRIPTS = [ln(SCOPE_ID), tsrScript_default];
